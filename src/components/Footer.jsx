...
function Footer() {
  ...
  <div>
    ...
    <a className="link link-hover">Ferienhaus Casa Ripa</a>
    <a className="link link-hover">Jasmin Ghubbar</a>
    <a className="link link-hover">Tannenweg 46</a>
    <a className="link link-hover">85399 Hallbergmoos</a>
